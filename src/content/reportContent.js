export const content = {
  ...
  s5Pipeline: {
    expert: "The tech industry is currently protected by a 'senior bulge'—a massive cohort of mid-to-senior engineers hired during 2010–2022. The structural crisis will hit 2033–2037 when this bulge ages out and the industry faces the missing 2023–2026 junior cohort. Important context on the 67% entry-level drop: the end of ZIRP triggered the initial freeze. But what makes this structural is the decoupling of capital and headcount. As budgets stabilized in 2025–2026, junior roles did not return. Companies deployed returning capital into compute and Senior Orchestrators. AI broke the historic, linear relationship between corporate growth and entry-level hiring.",

export const content = {
  ...
  s5Pipeline: {
    expert: "The Elastic Education Collapse: While 4-year CS enrollments lag due to institutional inertia, short-cycle training collapsed instantly. Coding bootcamp enrollments fell roughly 40% by early 2026, and universities report a sharp drop in sophomore-level CS major declarations. A structural shortage of expert verifiers is projected to land between 2033–2037.",
    essentials: "The Elastic Education Collapse: Short-term coding bootcamps have seen a 40% drop in enrollment as AI handles more entry-level tasks. While 4-year degrees take time to change, university sophomores are already switching away from CS majors at record rates."
  },
  s5Klarna: {

export const content = {
  ...
  s5Pipeline: {
    expert: "The tech industry is currently protected by a 'senior bulge'—a massive cohort of mid-to-senior engineers hired during 2010–2022. They are highly productive and acting as today's Meta-Verifiers. The structural crisis will hit 2033–2037 when this bulge ages out and the industry faces the missing 2023–2026 junior cohort. Important context on the 67% entry-level drop: the end of ZIRP triggered the initial freeze. But what makes this structural is the decoupling of capital and headcount. As budgets stabilized in 2025–2026, junior roles did not return. Companies deployed returning capital into compute and Senior Orchestrators. AI broke the historic, linear relationship between corporate growth and entry-level hiring.",
    essentials: "Tech's current strength comes from senior staff hired years ago. The crisis isn't now—it's in 2033, when these seniors retire and companies realize they stopped training new people in 2024. One key insight: even as capital returned to tech in 2025–2026, junior hiring didn't come back with it. Companies spent the money on compute and senior talent instead. AI permanently broke the old relationship between growth and entry-level hiring."
  },
  s5Klarna: {
